...
public class ParseLoginFragment extends ParseLoginFragmentBase implements httpParseResponse {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup parent,
        ...
        //parseLoginHelpButton = (Button) v.findViewById(R.id.);
        ...
        //Button link = (Button) v.findViewById(R.id.faceboo);
        //Button gm = (Button) v.findViewById(R.id.twitte);
        ...
        parseLoginButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (username.length() == 0) {
                    ...
                    String urlParameter = "grant_type=password&username=" + "siddimore@gmail.com" + "&password=" + "test123";
